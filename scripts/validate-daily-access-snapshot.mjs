...
assert.match(wallonia.access.no_match_follow_up_template.fr, /ouvert ou fermé aujourd’hui/);
assert.match(wallonia.access.no_match_follow_up_template.nl, /open of gesloten/);
assert.match(wallonia.access.no_match_follow_up_template.de, /geöffnet oder gesperrt/);
